    ...
    if user.nyanpuppu_simple_mode:
        ...
        if random.randint(1, 5) == 1:
            ...
            app_tips = [
                ...
                ("ガレージ設定から、君だけの公開プロフィールページを作れるにゃ。テーマも色々選べるにゃん！", "blobcat_excite.gif"),
                ("各記録の一覧画面にあるCSVエクスポート機能で、データのバックアップもバッチリにゃ。", None),
            ]
            advice_pool.extend(app_tips)

            # =================================================================
            # カテゴリ2: バイクTIPS (メンテナンス・ライディング)
            # =================================================================
            bike_tips = [
                # --- メンテナンス ---
                ...
                ("バッテリーが弱ってないかにゃ？冬は特に上がりやすいから注意にゃ。", "ablobcat_negi.gif"),
                ("チェーンのたるみ、大丈夫かにゃ？指二本分くらいが目安にゃん。", "ablobcat_fumi.gif"),
                ("ブレーキパッドの残量、溝を確認するにゃ。キーキー鳴ったら末期症状にゃん！", "blobcat_8bit_spin.gif"),
            ...
            humor_greetings = [
                ...
                ("また新しいパーツを買ったのかにゃ…？ご利用は計画的ににゃん！", "blobcat_8bit_spin.gif"),
                ("にゃーん（アイドリングの音）", "blobcat_sing.png"),
                ("バイクに乗りたい…乗せてほしいにゃん…", "blobcataww.png"),
                ("ヘルメットについた虫、ちゃんと取ったかにゃ？放置すると取れなくなるにゃん…。", "blobcat_guruguru.png"),

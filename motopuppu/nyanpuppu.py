    ...
    if user.nyanpuppu_simple_mode:
        ...
        if random.randint(1, 5) == 1:
            ...
            yamaha_trivia = [
                ...
                ("ヤマハの「TZR250R」のなかでも通称『サンマ』こと3MAは、理想の吸気を求めてキャブレターをエンジンの前、ラジエーターの真後ろに置くという、市販車なのにレーサー『YZR250』の技術を直輸入した常軌を逸した設計だったにゃ！セッティングの難しさとシート下の排熱と引き換えに手に入れた、独特のテールビューがたまらないにゃ！", "blobcatcomfy.png"),
